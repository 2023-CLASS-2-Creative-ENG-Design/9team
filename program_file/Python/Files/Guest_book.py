...
class Gui:
    def __init__(self):
        ...
        # com_port 아두이노와의 시리얼 통신을 위함
        # 아두이노는 컴퓨터와의 통신을 위해 특정 시리얼 포트(com포트)에 연결되는데
        # com 포트에 아두이노가 연결되어 있는지를 알아야함
        ...
        arduino_thread.daemon = True  # 메인 종료 시 함께 종료
